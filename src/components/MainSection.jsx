    ...
    <div>
      <div className="flex  h-screen bg-black">
        ...
        <div className=" flex justify-evenly items-center w-1/2">
          <Image src="/mainSection.png" className="" width="300" height="300" />
        </div>
      </div>
      <div className=" flex justify-between m-32">
         <div className="flex  bg-gray-200 w-1/4 p-5 rounded-md">
            <Image src="/apple.png" height="100" width="100" />
         ...
         <div className="flex  bg-gray-200 w-1/4 p-5 rounded-md">
            <Image src="/xiaomi.png" height="100" width="100" />
            <div className="flex flex-col justify-around pl-6">
         ...
         <div className="flex  bg-gray-200 w-1/4 p-5 rounded-md">
            <Image src="/fitbit.png" height="100" width="100" />
            <div className="flex flex-col justify-around pl-6">
